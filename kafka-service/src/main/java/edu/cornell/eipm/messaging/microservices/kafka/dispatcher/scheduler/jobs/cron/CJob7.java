...
@Configuration
@Component
@ConditionalOnProperty(name = "dispatcher.schedulers.cron.job7.active")
public class CJob7 extends JobRunner {

    @Scheduled(cron = "#{'${dispatcher.schedulers.cron.job7.when}'}")
    public void cronJob7() throws Exception {
        run(JOBTYPE.CRON,7);
    }
}
