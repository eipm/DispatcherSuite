...
@Configuration
@Component
@ConditionalOnProperty(name = "dispatcher.schedulers.cron.job6.active")
public class CJob6 extends JobRunner {

    @Scheduled(cron = "#{'${dispatcher.schedulers.cron.job6.when}'}")
    public void cronJob6() throws Exception {
        run(JOBTYPE.CRON,6);
    }
}
