...
@Configuration
@Component
@ConditionalOnProperty(name = "dispatcher.schedulers.cron.job5.active")
public class CJob5 extends JobRunner {

    @Scheduled(cron = "#{'${dispatcher.schedulers.cron.job5.when}'}")
    public void cronJob5() throws Exception {
        run(JOBTYPE.CRON,5);
    }
}
