...
@Configuration
@Component
@ConditionalOnProperty(name = "dispatcher.schedulers.cron.job1.active")
public class CJob1 extends JobRunner {

    @Scheduled(cron = "#{'${dispatcher.schedulers.cron.job1.when}'}")
